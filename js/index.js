var getStyle = function (element, style) {
  ...
  var Carousel = function (className, delay, transitionDelay) {
    //Init
    if(className === undefined) className = "carousel";
    ...
    //Get Elements
    var carouselElement = document.getElementsByClassName(this.className)[0];
    var carouselList = carouselElement.getElementsByClassName("carousel-list")[0];
    var carouselImageArray = carouselList.getElementsByTagName("img");
    ...
    carouselElement.appendChild(arrowLeft);
    ...
    carouselElement.appendChild(arrowRight);
    ...
    carouselElement.appendChild(dotElement);
    ...
    /*
    //Pause on Hover
    carouselList.onmouseover = function () {
      clearTimeout(sliderInterval);
      clearInterval(transitionInterval);
    };
    
    
    carouselList.onmouseout = function () {
      timeCounter = 0;
      initSliderTransition();
    };
    */
